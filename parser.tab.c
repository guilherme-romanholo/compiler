...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_LPARENT = 20,                   /* LPARENT  */
  YYSYMBOL_RBRACKET = 21,                  /* RBRACKET  */
  YYSYMBOL_LBRACKET = 22,                  /* LBRACKET  */
  YYSYMBOL_LKEY = 23,                      /* LKEY  */
  YYSYMBOL_RKEY = 24,                      /* RKEY  */
  YYSYMBOL_YYACCEPT = 25,                  /* $accept  */
  YYSYMBOL_declaracao = 26,                /* declaracao  */
  YYSYMBOL_lista_var = 27                  /* lista_var  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "CHARACTER", "STRING",
  "INTEGER", "REAL", "TYPE", "IF", "ELSE", "WHILE", "FOR", "RETURN", "ID",
  "OPERATOR", "ASSIGN", "LOGIC", "COLON", "SEMICOLON", "RPARENT",
  "LPARENT", "RBRACKET", "LBRACKET", "LKEY", "RKEY", "$accept",
  "declaracao", "lista_var", YY_NULLPTR
};
